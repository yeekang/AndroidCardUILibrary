...
public class SwipeDismissRecyclerViewTouchListener  implements View.OnTouchListener {
    ...
    /**
     * The callback itfcs used by {@link SwipeDismissRecyclerViewTouchListener} to inform its client
    ...
    public interface DismissCallbacks {
         ...
         */
        boolean canDismiss(View view, int position);
         ...
         */
        void onDismiss(RecyclerView recyclerView, int[] reverseSortedPositions, View removedView);
    }
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mDownView != null) {
                    ...
                    if (mCallbacks.canDismiss(mDownView, mDownPosition)) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mDismissAnimationRefCount == 0) {
                    ...
                    mCallbacks.onDismiss(mRecyclerView, dismissPositions, dismissView);
